...
// Define props for the component, including user email
...
export default function QuizComponent({
  ...
  const handleNextQuestion = () => {
    ...
    if (selectedOption !== quizData.answers[currentQuestion]) {
      setIncorrectQuestions((prev) => [...prev, quizData.questions[currentQuestion]])
    }
                ...
                <div className="flex flex-col items-center justify-center space-y-6">
                  ...
                  <div className="flex justify-between w-full">
                    <div className="flex items-center">
                      ...
                      <span>Correct: {quizData ? quizData.questions.length - incorrectQuestions.length : 0}</span>
                    </div>
                    <div className="flex items-center">
