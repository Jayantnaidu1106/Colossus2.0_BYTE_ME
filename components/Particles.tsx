...
// Use inline styles instead of importing CSS file
...
const Particles: React.FC<ParticlesProps> = ({
  ...
  useEffect(() => {
    ...
    const renderer = new Renderer({ depth: false, alpha: true, antialias: true, dpr });
    const gl = renderer.gl;
    container.appendChild(gl.canvas);
    // Set up WebGL context with safe defaults
    try {
